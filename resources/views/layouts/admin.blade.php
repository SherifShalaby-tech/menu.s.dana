...
@section('content_top_nav_right')
    @if (!empty(env('POS_SYSTEM_URL')))
        <a class="mb-3 btn btn-primary btn-flat" href="{{ env('POS_SYSTEM_URL') }}" target="_blank"
    ...
    <li class=" nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown" aria-expanded="true">
            <img class="object-cover w-5 h-5 mx-1 rounded-full"
        ...
        <ul class="border-0 shadow dropdown-menu" style="left: 0px; right: 0;">
            <li>
