    ...
    <div class="footer-widget section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="single-widget single-widget1 row" style="display: flex;align-items: center;">
                        ...
                        <div class="text-center d-flex col-6">
                                            ...
                                            <div class="info-text">
                                                 <h5 class="mb-1" style="line-heigth=2px; "> @lang('lang.about_us')</h5>
                                                    <h6>
                                                    ...
                                                    <p class="text-center text-white">
                                                        <a href="{{ action('AboutUsController@index') }}"
                                                            class="px-3 py-2 font-bold text-white border-2 border-white rounded-lg bg-red md:text-base xs:text-sm no-wrap">@lang('lang.show_more')
                                                        </a>
                                                    </p>
                                            </div>
                                        </div>
                ...
                <div class="col-md-4">
                    <div class="my-5 single-widget single-widget2 my-md-0">
