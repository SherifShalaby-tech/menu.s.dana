        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="input-group my-group">
                    {!! Form::select('product_class_id', $categories, false, [
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <x-adminlte-input name="name" required label="{{ __('lang.name') }}"
                        placeholder="{{ __('lang.name') }}" enable-old-support style="width: 80%">
            ...
            <div class="col-md-12 ">
                <table class="table" id="size_table">
                    ...
                    <tbody>
                        <td style='width: 15%'>
                            <div class="input-group my-group ">
                                {!! Form::select('sizes[0][size_id]', $sizes, [
                        ...
                        <td style='width: 10%'>
                            {!! Form::text('sizes[0][purchase_price]', null, [
                                'class' => 'form-control',
                                'placeholder' =>
                        ...
                        <td style='width: 10%'>
                            {!! Form::text('sizes[0][sell_price]', null, [
                                'class' => 'form-control',
                        ...
                        <td style='width: 10%'>
                            {!! Form::select(
                                'sizes[0][discount_type]',
                                ['fixed' => __('lang.fixed'), 'percentage' => __('lang.percentage')],
                                'fixed',
                                ['class' => 'form-control', 'style' => 'width: 80%', 'placeholder' => __('lang.please_select')],
                            ) !!}
                        </td>
                        <td style='width: 10%'>
                        ...
                        <td>
                            {!! Form::text('sizes[0][discount_start_date]', null, [
                                'class' => 'form-control datepicker',
                                'placeholder' => __('lang.discount_start_date'),
                            ]) !!}
                        </td>
                        <td>
                            {!! Form::text('sizes[0][discount_end_date]', null, [
                                'class' => 'form-control datepicker',
                                'placeholder' => __('lang.discount_end_date'),
                            ]) !!}
                        </td>
                        <td> <button type="button" class="btn btn-danger btn-xs remove_row mt-2"><i
            ...
            <div class="col-md-12" style="margin-top: 10px">
                <div class="custom-control custom-checkbox">
                    ...
                    <label for="this_product_have_variant" class="custom-control-label">@lang('lang.this_product_have_variant')</label>
                </div>
            </div>
        ...
        function getImages() {
            setTimeout(() => {
                ...
                for (let i = 0; i < container[0].children.length; i++) {
                    ...
                    var newInput = $("<input>").attr("type", "hidden").attr("name", "image").val(container[0]
